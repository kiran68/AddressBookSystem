	 ...
	 public void writeToFile(String filename) {
	    ...
	    public void writeIntoJson() throws IOException {
			...
			FileWriter fileWriter = new FileWriter(
					"C:\\\\Users\\\\HP\\\\eclipse-workspace\\\\AdvAddressBook\\\\src\\\\main\\\\java\\\\com\\\\bridgelabz\\\\advaddressbook\\\\Book.json");

			Contacts person = new Contacts();
			person.setFirstName("Kiran");
			person.setLastName("Urshil");
			person.setAddress("BajajNagar");
			person.setPhoneNumber(91680681);
